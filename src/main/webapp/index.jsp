...
<%
	if(Integer.parseInt(request.getParameter("loginid"))==723){
...
<h1 style="font-weight: 50">Login</h1>
	<form method="post" action="index.jsp">
		<input type="number" name="loginid" required autocomplete="off" style="padding: 5px; width: 140px; border: none; border-radius: 10px;" placeholder="Enter your login id...">
